...
- (arXiv 2023) **DyLAN** — A dynamic LLM-powered agent network for task-oriented agent collaboration [[Paper]](https://arxiv.org/abs/2310.02170)
- (ICLR 2025) **Agent-Oriented Planning** — Agent-oriented planning in multi-agent systems [[Paper]](https://scholar.google.com/scholar?q=Agent-oriented+planning+in+multi-agent+systems)
- (Paper 2025) **MasRouter** — Masrouter: Learning to route llms for multi-agent systems [[Paper]](https://scholar.google.com/scholar?q=Masrouter%3A+Learning+to+route+llms+for+multi-agent+systems)
- (arXiv 2023) **AutoAgents** — Autoagents: A framework for automatic agent generation [[Paper]](https://arxiv.org/abs/2309.17288)
- (Paper 2025) **EvoAgent** — Evoagent: Towards automatic multi-agent generation via evolutionary algorithms [[Paper]](https://scholar.google.com/scholar?q=Evoagent%3A+Towards+automatic+multi-agent+generation+via+evolutionary+algorithms)
- (ICLR 2026) **Collaborative Gym** — Collaborative gym: A framework for enabling and evaluating human-agent collaboration [[Paper]](https://scholar.google.com/scholar?q=Collaborative+gym%3A+A+framework+for+enabling+and+evaluating+human-agent+collaboration)
- (arXiv 2026) **AOrchestra** — Aorchestra: Automating sub-agent creation for agentic orchestration [[Paper]](https://arxiv.org/abs/2602.03786)
- (arXiv 2025) **Captain Agent** — Adaptive graph pruning for multi-agent communication [[Paper]](https://arxiv.org/abs/2506.02951)
- (arXiv 2025) **MaAS** — Multi-agent architecture search via agentic supernet [[Paper]](https://arxiv.org/abs/2502.04180)
...
- (ICLR 2024) **MetaGPT** — MetaGPT: Meta Programming for A Multi-Agent Collaborative Framework [[Paper]](https://openreview.net/forum?id=VtmBAGCN7o)
- (Paper 2024) **ChatDev** — ChatDev: Communicative Agents for Software Development [[Paper]](https://aclanthology.org/2024.acl-long.810/)
- (arXiv 2024) **Magentic-One** — Magentic-one: A generalist multi-agent system for solving complex tasks [[Paper]](https://arxiv.org/abs/2411.04468)
- (ICLR 2024) **AgentVerse** — Agentverse: Facilitating multi-agent collaboration and exploring emergent behaviors [[Paper]](https://scholar.google.com/scholar?q=Agentverse%3A+Facilitating+multi-agent+collaboration+and+exploring+emergent+behaviors)
- (NeurIPS 2026) **Puppeteer** — Multi-agent collaboration via evolving orchestration [[Paper]](https://scholar.google.com/scholar?q=Multi-agent+collaboration+via+evolving+orchestration)
...
- (ICLR 2025) **MacNet** — Scaling large language model-based multi-agent collaboration [[Paper]](https://scholar.google.com/scholar?q=Scaling+large+language+model-based+multi-agent+collaboration)
...
- (ICLR 2025) **Mixture-of-Agents** — Mixture-of-agents enhances large language model capabilities [[Paper]](https://scholar.google.com/scholar?q=Mixture-of-agents+enhances+large+language+model+capabilities)
- (arXiv 2024) **G-Designer** — G-designer: Architecting multi-agent communication topologies via graph neural networks [[Paper]](https://arxiv.org/abs/2410.11782)
- (Paper 2025) **AMAS** — Amas: Adaptively determining communication topology for llm-based multi-agent system [[Paper]](https://scholar.google.com/scholar?q=Amas%3A+Adaptively+determining+communication+topology+for+llm-based+multi-agent+system)
- (ICLR 2025) **AgentPrune** — Cut the crap: An economical communication pipeline for llm-based multi-agent systems [[Paper]](https://scholar.google.com/scholar?q=Cut+the+crap%3A+An+economical+communication+pipeline+for+llm-based+multi-agent+systems)
- (Paper 2025) **AgentDropout** — Agentdropout: Dynamic agent elimination for token-efficient and high-performance llm-based multi-agent collaboration [[Paper]](https://scholar.google.com/scholar?q=Agentdropout%3A+Dynamic+agent+elimination+for+token-efficient+and+high-performance+llm-based+multi-agent+collaboration)
